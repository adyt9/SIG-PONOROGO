				...
				<div class="col-md-12">
					<div class="ibox float-e-margins">
						...
						<div class="ibox-content">
							<form action="<?= site_url('Wisata/add') ?>" method="POST" enctype="multipart/form-data">
								<div class="form-group row">
									<label for="staticEmail" class="col-sm-2 col-form-label">Wisata</label>
									<div class="col-sm-4">
										<input type="text" name="nama_wisata" class="form-control" id="nama_wisata" placeholder="Wisata" required>
									</div>
								</div>
								<div class="form-group row">
									<label for="staticEmail" class="col-sm-2 col-form-label">Buka</label>
									<div class="col-xs-4 col-sm-3 col-md-3 clockpicker">
										<input type="time" name="buka" class="form-control " id="buka" placeholder="Buka" required>
									</div>
									<div class="col-xs-1 col-sm-1 col-md-1">-</div>
									<div class="col-xs-4 col-sm-3 col-md-3 clockpicker">
										<input type="time" name="tutup" class="form-control" id="tutup" placeholder="Tutup" required>
									</div>
								</div>
								<div class="form-group row">
