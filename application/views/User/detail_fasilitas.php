                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <div class="white-box">
                            <div class="user-bg"> <img style="object-fit:cover;object-position:center;" width="100%" alt="user" src="<?= base_url('image/').$row->gambar_fasilitas; ?>">
                                <div class="">
                            ...
                            <div class="user-btm-box">
                                <div class="col-md-12 col-sm-12 text-center">
                                    ...
                                    <h3>Fasilitas <?= $row->nama_fasilitas; ?></h3> </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            ...
                            <h3><b>Deskripsi fasilitas</b></h3><hr/>
                            <p><?= $row->deskripsi;?></p>
                            <h3><b>Alamat fasilitas</b></h3><hr/>
                            <p><?= $row->alamat;?></p>
