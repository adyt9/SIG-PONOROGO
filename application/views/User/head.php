...
<head>
    ...
    <!-- color CSS -->
    <link href="<?php echo base_url("asset") ?>/css/colors/default-dark.css" id="theme" rel="stylesheet">
            ...
            <div class="navbar-header">
                <div class="top-left-part">
                    ...
                    <a class="logo" href="<?php echo $halaman_index?>">
                        ...
                        <!--This is dark logo icon--><img src="<?php echo base_url("asset") ?>/plugins/images/admin-logo.png" alt="home" class="dark-logo" /><!--This is light logo icon--><img src="<?php echo base_url("asset") ?>/plugins/images/admin-logo-dark.png" alt="home" class="light-logo" />
                     </b>
                ...
                <!-- /Logo -->
                    ...
                    <!-- .Megamenu -->
                    <li class="mega-dropdown"> <a class="dropdown-toggle waves-effect waves-light" href="<?= site_url()?>"><span class="hidden-xs">Home</span> </a>
                    </li>
                    <li class="mega-dropdown"> <a class="dropdown-toggle waves-effect waves-light" href="<?= site_url('User/informasi_wisata')?>"><span class="hidden-xs">Informasi Wisata</span> </a>
                    </li>
                    <li class="mega-dropdown"> <a class="dropdown-toggle waves-effect waves-light" href="javascript:void(0)"><span class="hidden-xs">Peta Lokasi</span> </a>
                    </li>
                    <li class="mega-dropdown"> <a class="dropdown-toggle waves-effect waves-light" href="javascript:void(0)"><span class="hidden-xs">Galeri</span> </a>
                    </li>
                    <li class="mega-dropdown"> <a class="dropdown-toggle waves-effect waves-light" href="<?= site_url('User/video')?>"><span class="hidden-xs">Video Wisata</span> </a>
                    </li>
                    <!-- /.Megamenu -->
                </ul>
